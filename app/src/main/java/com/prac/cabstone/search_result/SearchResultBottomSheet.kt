...
class SearchResultBottomSheet(var mContext: Context, var responseGetInfoForAreaData: ResponseGetInfoForAreaData) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        mTvTitle.text = responseGetInfoForAreaData.getTitle()
        mTvLocation.text = responseGetInfoForAreaData.getAddr1()
        GlideApp.with(mContext).load(responseGetInfoForAreaData.getFirstImage())
            .centerCrop()
            .into(mImageView)
