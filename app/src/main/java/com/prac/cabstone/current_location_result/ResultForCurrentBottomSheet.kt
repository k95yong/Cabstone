...
class ResultForCurrentBottomSheet(var mContext: Context, var responseGetResultForCurrentData: ResponseGetResultForCurrentData) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        mTvTitle.text = responseGetResultForCurrentData.getTitle()
        mTvLocation.text = responseGetResultForCurrentData.getAddr1()
        GlideApp.with(mContext).load(responseGetResultForCurrentData.getFirstImage())
            .centerCrop()
            .into(mImageView)
        ...
        mBtnDetail.setOnClickListener(object : OnSingleClickListener() {
            override fun onSingleClick(v: View) {
                ...
                intent.putExtra("content_id", responseGetResultForCurrentData.getContentId())
